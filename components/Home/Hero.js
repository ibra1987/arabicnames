...
const Hero = () => {
  ...
  const ExploreButtonStyles =
    " w-11/12  py-2 bg-white mx-4 ouline-none border tracking-widest border-pink-500 font-bold text-pink-500 cursor-pointer hover:bg-pink-500 hover:text-white ease-in duration-300   rounded-md popins";
  const InputStyle =
